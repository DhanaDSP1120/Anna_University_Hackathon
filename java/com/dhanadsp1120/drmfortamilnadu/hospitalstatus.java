...
public class hospitalstatus extends AppCompatActivity {
    Spinner dis;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hospitalstatus);
        s0 = findViewById(R.id.district);
        s2 = findViewById(R.id.hospital);
        status = findViewById(R.id.status);
        no = findViewById(R.id.No);
        hospitaladmission.city.add(0, "Select city");
        hospital.add(0, "Select Hospital");
        ArrayAdapter<String> ad0 = new ArrayAdapter<>(this, android.R.layout.simple_spinner_dropdown_item, hospitaladmission.city);
        s0.setAdapter(ad0);
        ...
        s0.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    db = FirebaseDatabase.getInstance().getReference().child("toll-free").child("hospital").child(hospitaladmission.state1).child(city1);
    ...
    public void check(View v)
    {
        ...
        if (city1.length() == 0) {
            ...
            dialog = new ACProgressFlower.Builder(hospitalstatus.this)
                    .direction(ACProgressConstant.DIRECT_CLOCKWISE)
                    .themeColor(Color.WHITE)
                    .fadeColor(Color.DKGRAY).build();
            dialog.show();
            db1 = FirebaseDatabase.getInstance().getReference().child("hospital").child("accept").child(hospitaladmission.state1).child(city1).child(hospital1);
    ...
    public void data2()
    {
        db2 = FirebaseDatabase.getInstance().getReference().child("hospital").child("rejected").child(hospitaladmission.state1).child(city1).child(hospital1);
    ...
    public void data3()
    {
        ...
        db3 = FirebaseDatabase.getInstance().getReference().child("hospital").child("applied").child(hospitaladmission.state1).child(city1).child(hospital1);
