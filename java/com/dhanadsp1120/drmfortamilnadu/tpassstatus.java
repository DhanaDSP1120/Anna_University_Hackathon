...
public class tpassstatus extends AppCompatActivity {
    Spinner dis;
...
public int acc=0,app=0,rej=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tpassstatus);
        dis=findViewById(R.id.district);
        status=findViewById(R.id.status);
        no=findViewById(R.id.No);
        tpass.city.add(0,"Select city");
        ArrayAdapter<String> ad0=new ArrayAdapter<>(this,android.R.layout.simple_spinner_dropdown_item,tpass.city);
        dis.setAdapter(ad0);
        dis.setSelection(0);
    ...
    public void check(View v) {
        ...
        if (district.length() == 0) {
            ...
            dialog = new ACProgressFlower.Builder(tpassstatus.this)
                    .direction(ACProgressConstant.DIRECT_CLOCKWISE)
                    .themeColor(Color.WHITE)
                    .fadeColor(Color.DKGRAY).build();
            dialog.show();
            Log.d("d","ddd");
            db1 = FirebaseDatabase.getInstance().getReference().child("tpass").child("accept").child(epass.state1).child(district);
    ...
    public void data2()
    {
        db2 = FirebaseDatabase.getInstance().getReference().child("tpass").child("rejected").child(epass.state1).child(district);
    ...
    public void data3()
    {
        ...
        db3 = FirebaseDatabase.getInstance().getReference().child("tpass").child("applied").child(epass.state1).child(district);
