...
public class epass extends AppCompatActivity {
    ...
    {
        if (isConnected()) {
            dialog = new ACProgressFlower.Builder(epass.this)
            ...
            db.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    startActivity(new Intent(epass.this,epassapply.class));
                }
            ...
            AlertDialog.Builder on = new AlertDialog.Builder(epass.this);
            on.setTitle("Warning")
        ...
        if (isConnected()) {
            ...
            db.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    startActivity(new Intent(epass.this,epassstatus.class));
                }
