...
public class hospitaladmission extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hospitaladmission);
    }
    @Override
    ...
    {
        if (isConnected()) {
            dialog = new ACProgressFlower.Builder(hospitaladmission.this)
            ...
            db.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    startActivity(new Intent(hospitaladmission.this,hospital.class));
                }
            ...
            AlertDialog.Builder on = new AlertDialog.Builder(hospitaladmission.this);
            on.setTitle("Warning")
        ...
        if (isConnected()) {
            ...
            db.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    startActivity(new Intent(hospitaladmission.this,hospitalstatus.class));
                }
