...
public class doctorappoinment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctorappoinment);
    }
    ...
    {
        if (isConnected()) {
            dialog = new ACProgressFlower.Builder(doctorappoinment.this)
            ...
            db.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    startActivity(new Intent(doctorappoinment.this,appoinment.class));
                }
            ...
            AlertDialog.Builder on = new AlertDialog.Builder(doctorappoinment.this);
            on.setTitle("Warning")
        ...
        if (isConnected()) {
            ...
            db.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    startActivity(new Intent(doctorappoinment.this,appoinmentstatus.class));
                }
